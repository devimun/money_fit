...
void main() {
  group('ThemeSettings Property Tests', () {
    ...
    test('Property 3: Theme Persistence Round Trip - '
    ...
    test('Property 3 Edge Case: Empty favorite colors list', () {
    ...
    test('Property 3 Edge Case: Large favorite colors list', () {
    ...
    test('Property 3 Edge Case: Extreme color values', () {
      final settings = const ThemeSettings(
        isDarkMode: true,
    ...
    test('Property 3 Edge Case: Default settings round trip', () {
  ...
  group('ThemeSettings JSON Robustness Tests', () {
    test('fromJson handles missing fields with defaults', () {
      ...
      final settings3 = ThemeSettings.fromJson({'colorSeedValue': 0xFF123456});
    ...
    test('fromJson handles invalid fontSizeScale values', () {
    ...
    test('fromJson handles invalid favoriteColors types', () {
  ...
  group('ThemeSettings Utility Methods Tests', () {
    test('colorSeed getter returns correct Color object', () {
    ...
    test('favoriteColorObjects getter returns correct Color list', () {
      const settings = ThemeSettings(
        isDarkMode: false,
    ...
    test('fontSizeOption getter returns correct FontSizeOption', () {
    ...
    test('copyWith creates new instance with updated values', () {
      ...
      final updated3 = original.copyWith(
        favoriteColors: [0xFF111111, 0xFF222222],
      );
  ...
  group('ThemeSettings Equality Tests', () {
    ...
    test('Equality handles different favorite colors order', () {
      const settings1 = ThemeSettings(
        isDarkMode: true,
        colorSeedValue: 0xFF123456,
        favoriteColors: [0xFF000000, 0xFF111111],
    ...
    test('Equality handles different favorite colors length', () {
      const settings1 = ThemeSettings(
        isDarkMode: true,
        colorSeedValue: 0xFF123456,
        favoriteColors: [0xFF000000],
