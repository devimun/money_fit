...
void main() {
  group('ThemeExtensions Property Tests', () {
    ...
    testWidgets('Property 5: Theme Extension Non-Null - '
        'For any BuildContext with a properly configured theme, '
        'context.theme should never return null', (WidgetTester tester) async {
          ...
          MaterialApp(
            ...
            home: Builder(
              builder: (context) {
                ...
                expect(
                  theme.brandPrimary,
                  equals(randomTheme.brandPrimary),
                  reason:
                ...
                expect(
                  theme.textPrimary,
                  equals(randomTheme.textPrimary),
                  reason:
                      'context.theme should return the correct theme (run $i)',
                );
                ...
                expect(
                  ...
                  equals(randomTheme.screenBackground),
                  reason:
                      'context.theme should return the correct theme (run $i)',
                );
        ...
        MaterialApp(
          ...
          home: Builder(
            builder: (context) {
              ...
              expect(
                theme.brandPrimary,
                equals(defaultTheme.brandPrimary),
                reason: 'Should return default theme brandPrimary',
              );

              expect(
                theme.textPrimary,
                equals(defaultTheme.textPrimary),
                reason: 'Should return default theme textPrimary',
              );

              expect(
                theme.screenBackground,
                equals(defaultTheme.screenBackground),
    ...
    testWidgets('context.textTheme returns non-null TextTheme', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('context.brightness returns valid Brightness', (
      WidgetTester tester,
    ) async {
      // Test light mode
      await tester.pumpWidget(
    ...
    testWidgets('context.isDarkMode correctly identifies dark mode', (
      WidgetTester tester,
    ) async {
            ...
            home: Builder(
              builder: (context) {
                expect(
                  context.isDarkMode,
                  equals(isDark),
                  reason: 'isDarkMode should match brightness setting (run $i)',
                );
