...
void main() {
  group('AppThemeGenerator Property Tests', () {
    ...
    test('Property 1: Theme Color Consistency - '
      ...
      for (int i = 0; i < numRuns; i++) {
        ...
        final lightLightness = HSLColor.fromColor(
          lightTheme.brandPrimary,
        ).lightness;
        final darkLightness = HSLColor.fromColor(
          darkTheme.brandPrimary,
        ).lightness;

        // Both themes preserve the selected seed as their primary color.
        // Dark-mode readability is provided by the surrounding palette.
        expect(
          darkLightness,
          equals(lightLightness),
          reason:
              'Dark mode primary should preserve the selected seed (run $i)',
        );
      }
    });

    test('Property 1 Edge Case: Default seed maintains hue consistency', () {
      final lightTheme = AppThemeGenerator.lightFromSeed(
        AppThemeGenerator.defaultSeed,
      );
      final darkTheme = AppThemeGenerator.darkFromSeed(
        AppThemeGenerator.defaultSeed,
      );
    ...
    test('Property 1 Edge Case: Pure colors maintain hue consistency', () {
      final pureColors = [
        Colors.red,
        Colors.green,
        Colors.blue,
  ...
  group('AppThemeGenerator Contrast Ratio Tests', () {
    ...
    test('Property 2: Contrast Ratio Validation - '
    ...
    test('Property 2 Edge Case: Default seed provides sufficient contrast', () {
      final lightTheme = AppThemeGenerator.lightFromSeed(
        AppThemeGenerator.defaultSeed,
      );
      final darkTheme = AppThemeGenerator.darkFromSeed(
    ...
    test('Property 2 Edge Case: Extreme colors provide sufficient contrast', () {
      final extremeColors = [
        Colors.black,
        Colors.white,
    ...
    test('_getContrastColor returns black for light backgrounds', () {
      final lightColors = [
        Colors.white,
    ...
    test('_getContrastColor returns white for dark backgrounds', () {
      final darkColors = [
        Colors.black,
