...
void main() {
  group('HSVColorPicker Property Tests', () {
      ...
      () {
        ...
        for (int i = 0; i < numRuns; i++) {
          ...
          expect(
            ...
            isTrue,
            reason:
                'Color round-trip failed for run $i: '
    ...
    test('HSV round-trip preserves color components within tolerance', () {
      ...
      for (final originalColor in testColors) {
        ...
        expect(
          ...
          isTrue,
          reason:
              'Color round-trip failed for ${_colorToString(originalColor)}: '
              'Converted to ${_colorToString(convertedColor)}',
        );
      }
    });

    test('HSV components are within valid ranges', () {
    ...
    test('HSV manipulation preserves valid color space', () {
      final random = Random(42);
      const numRuns = 50;
