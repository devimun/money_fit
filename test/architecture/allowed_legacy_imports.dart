...
const allowedLegacyImports = <LegacyBoundaryAllowance>[
  ...
  LegacyBoundaryAllowance(
    ...
    kind: LegacyBoundaryKind.coreToFeatureImport,
    target: 'package:money_fit/features/auth/view/splash_screen.dart',
    reason: 'The router is still located in core before app composition moves.',
    owner: LegacyOwner.appComposition,
    removalPhase: RemovalPhase.pr2_1,
  ),
  LegacyBoundaryAllowance(
    filePath: 'lib/core/router/app_router.dart',
    kind: LegacyBoundaryKind.coreToFeatureImport,
    target: 'package:money_fit/features/statistics/view/statistics.dart',
    reason: 'The router is still located in core before app composition moves.',
    owner: LegacyOwner.appComposition,
    removalPhase: RemovalPhase.pr2_1,
  ),
  LegacyBoundaryAllowance(
    filePath: 'lib/core/router/app_router.dart',
    kind: LegacyBoundaryKind.coreToFeatureImport,
    target: 'package:money_fit/features/home/view/home_screen.dart',
    reason: 'The router is still located in core before app composition moves.',
    owner: LegacyOwner.appComposition,
    removalPhase: RemovalPhase.pr2_1,
  ),
  LegacyBoundaryAllowance(
    filePath: 'lib/core/router/app_router.dart',
    kind: LegacyBoundaryKind.coreToFeatureImport,
    target: 'package:money_fit/features/calendar/view/calendar_screen.dart',
    reason: 'The router is still located in core before app composition moves.',
    owner: LegacyOwner.appComposition,
    removalPhase: RemovalPhase.pr2_1,
  ),
  LegacyBoundaryAllowance(
    filePath: 'lib/core/router/app_router.dart',
    kind: LegacyBoundaryKind.coreToFeatureImport,
    target: 'package:money_fit/features/expense/view/expense_list_screen.dart',
    reason: 'The router is still located in core before app composition moves.',
    owner: LegacyOwner.appComposition,
    removalPhase: RemovalPhase.pr2_1,
  ),
  LegacyBoundaryAllowance(
    filePath: 'lib/core/router/app_router.dart',
    kind: LegacyBoundaryKind.coreToFeatureImport,
    target: 'package:money_fit/features/settings/view/settings_screen.dart',
    reason: 'The router is still located in core before app composition moves.',
    owner: LegacyOwner.appComposition,
    removalPhase: RemovalPhase.pr2_1,
  ),
  LegacyBoundaryAllowance(
    ...
    kind: LegacyBoundaryKind.coreToFeatureImport,
    target:
        'package:money_fit/features/onboarding/view/budget_setup_screen.dart',
    reason: 'The router is still located in core before app composition moves.',
    owner: LegacyOwner.appComposition,
    removalPhase: RemovalPhase.pr2_1,
  ),
  ...
  LegacyBoundaryAllowance(
    filePath: 'lib/core/providers/database_provider.dart',
    kind: LegacyBoundaryKind.sdkSingleton,
    target: 'DatabaseHelper.instance',
    reason: 'The v5 database singleton precedes the injectable AppDatabase.',
    owner: LegacyOwner.appComposition,
  ...
  LegacyBoundaryAllowance(
    ...
    kind: LegacyBoundaryKind.sdkSingleton,
    target: 'FirebaseAnalytics.instance',
    reason: 'Router analytics is moved with app composition.',
    owner: LegacyOwner.appComposition,
    removalPhase: RemovalPhase.pr2_1,
  ),
  LegacyBoundaryAllowance(
