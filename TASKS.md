...
- [o] **Firebase 서비스 연동**
  - [o] `firebase_analytics`를 이용한 화면 조회 및 주요 이벤트 로깅
  - [o] `google_mobile_ads`를 이용한 배너 광고 등 광고 단위 추가
- [o] **최적화 및 폴리싱**
  - [o] 앱 아이콘 및 스플래시 스크린 적용
  - [o] 성능 프로파일링 및 최적화 (느린 위젯, 불필요한 리빌드 등)
  - [o] 최종 UI/UX 검토 및 수정
- [ ] **배포 준비**
  - [o] Google Play Store 및 Apple App Store 등록 준비
  - [o] 앱 서명(Signing) 설정
  - [ ] 스크린샷 및 앱 설명 자료 준비
