...
abstract class AppLocalizations {
  ...
  /// No description provided for @analyticsCollection.
  ///
  /// In en, this message translates to:
  /// **'Analytics collection'**
  String get analyticsCollection;
  ...
  /// No description provided for @review_negative_validation_error.
  ///
  /// In en, this message translates to:
  /// **'Please enter at least 3 characters.'**
  String get review_negative_validation_error;

  /// No description provided for @review_negative_submit_error.
  ///
  /// In en, this message translates to:
  /// **'We couldn’t send it. Your text is still here—please try again.'**
