...
/// Applies the tracking-plan contract before any SDK sees an event.
///
/// This is deliberately an allowlist rather than a generic "safe enough"
/// filter: a newly added property is dropped until it is reviewed here.
